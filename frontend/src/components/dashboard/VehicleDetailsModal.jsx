                                        ...
                                        <div className="grid grid-cols-2 gap-3">
                                            {vehiculo.fotos.map((foto, index) => (
                                                <button
                                                    ...
                                                    className="aspect-4/3 bg-gray-100 rounded-xl border border-gray-200 flex items-center justify-center relative group overflow-hidden cursor-pointer p-0"
                                                    aria-label={`Ver evidencia fotográfica ${index + 1}`}
                                                >
                                                    <img
                                                        src={foto}
